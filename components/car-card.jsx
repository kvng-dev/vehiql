    ...
    <Card className="group overflow-hidden hover:shadow-lg transition py-0">
      <div className="relative h-48">
        ...
        <Button
          variant={"ghost"}
          size={"icon"}
          className={`absolute top-2 right-2 bg-white/90 backdrop-blur-md border rounded-full p-1.5 hover:bg-white/100 transition duration-300
            ${
              isSaved
      ...
      <CardContent className="p-4">
        ...
        <div className="text-gray-600 mb-2 flex items-center">
          <span>{car.year}</span>
          <span className="h-1.5 w-1.5 bg-gray-600 rounded-full mx-2" />
