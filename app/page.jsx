...
import CarCard from "@/components/car-card";
import HomeSearch from "@/components/home-search";
import { bodyTypes, carMakes, faqItems } from "@/components/lib/data";
import {
  Accordion,
  AccordionContent,
  AccordionTrigger,
...
export default async function Home() {
  ...
  return (
    <div className="pt-20 flex flex-col">
      ...
      <section className="relative py-16 md:py-28 dotted-bg">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className=" md:text-xl text-gray-500 mb-8 max-w-2xl mx-auto">
              Discover the perfect vehicle tailored to your needs with our
      ...
      <section className="py-24 dotted-bg text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">
            Ready to Find Your Dream Car?
          </h2>
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of satified customers who found their perfect vehicle
