...
import { Camera, Loader, Loader2, Trash2, Upload, X } from "lucide-react";
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    placeholder="Enter detailed desc of the car..."
                    rows={6}
                ...
                <div className="flex items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  <div className="space-y-1 leading-none">
                    <Label htmlFor="">Feature this Car</Label>
                ...
                <div className="space-y-2">
                  ...
                  <div
                    ...
                    className={`cursor-pointer border-2 border-dashed rounded-lg p-6 text-center hover:bg-gray-50 transition ${
                ...
                {uploadingImages.length > 0 && (
                  <div className="mt-4">
                    <h3 className="text-sm font-medium mb-6">
                      Uploaded Images ({uploadingImages.length})
                    </h3>
        ...
        <TabsContent value="ai" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Upload an image of a car & let AI extract its details
              </CardDescription>
            </CardHeader>
            <CardContent>
