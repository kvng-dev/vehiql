...
import EmiCalculator from "../[id]/emi-calculator";
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 my-6">
            ...
            <div className="flex items-center gap-2">
              <Milestone className="text-gray-500 h-5 w-5" />
          ...
          <Card className="my-4">
            <CardContent className="p-4">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Our Respresentatives are available to answer all your queries
                about this vehicle
              </p>
              <a href="mailto:help@vehiql.to">
